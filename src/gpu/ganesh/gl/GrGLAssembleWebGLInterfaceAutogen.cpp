...
// Non-emscripten WebGL interface: uses the get callback to resolve GL function
// pointers at runtime (same mechanism as the GLES interface). This enables
// SK_ASSUME_WEBGL builds on wasm32-unknown-unknown where GL is provided via
// a JS proxy rather than emscripten's built-in WebGL bindings.
